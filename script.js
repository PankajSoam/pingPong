...
const rod1Name = "Blue Player";
const rod2Name = "Green Player";
...
window.addEventListener('keydown', function () {
    ...
    if ((event.code === "KeyD" || event.key=== "ArrowRight" )&& ((rodRect.x + rodRect.width) < window.innerWidth)) {
        rod1.style.left = (rodRect.x) + rodSpeed + 'px';
        rod2.style.left = rod1.style.left;
    } else if ((event.code === "KeyA" || event.key === "ArrowLeft")&& (rodRect.x > 0)) {
        rod1.style.left = (rodRect.x) - rodSpeed + 'px';
        rod2.style.left = rod1.style.left;
    }
